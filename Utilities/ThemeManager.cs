...
> <Grid>";
        ...
        private static void SetBurntKermitColors()
        {
            ...
            ButtonTextColor = Color.White;//Color.Black;                    // This changes the colour of button text
            ButBG = Color.FromArgb(0,150,150);//Color.FromArgb(0, 255, 255);                           // This changes the colour of button backgrounds (Top)
            ButBGBot = Color.FromArgb(0, 100, 100);//Color.FromArgb(0, 200, 200);                       // This changes the colour of button backgrounds (Bot)
           ...
           BGColorTextBox = ControlBGColor;                                // This changes the colour of the background of textboxes
            ...
            if (MainV2.instance != null && MainV2.instance.FlightPlanner != null)
            {
                ...
                actionPanel.CustomColors.CaptionGradientBegin = Color.FromArgb(0, 150, 150);//ButBG;
                actionPanel.CustomColors.CaptionGradientEnd = Color.FromArgb(0, 100, 100);//ButBGBot;
