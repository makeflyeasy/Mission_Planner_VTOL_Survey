...
namespace MissionPlanner.GCSViews
{
    public partial class FlightData : MyUserControl, IActivate, IDeactivate
    {
        ...
        private bool huddropout;
        private bool huddropoutresize;
        ...
        private bool outputwindowstarted;
        ...
        private void NoFly_NoFlyEvent(object sender, NoFly.NoFly.NoFlyEventArgs e)
        {
        ...
        private void tabStatus_Resize(object sender, EventArgs e)
        {
            // localise it
        ...
        private void cam_camimage(Image camimage)
        {
        ...
        private void dropout_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void dropout_Resize(object sender, EventArgs e)
        {
            if (huddropoutresize)
                return;
...
((CheckBox)a).BackColor = Color.Green;
        ...
        private void run_selected_script()
        {
        ...
        {
            MainV2.comPort.doCommand((MAVLink.MAV_CMD)Enum.Parse(typeof(MAVLink.MAV_CMD), MAVLink.MAV_CMD.DO_PARACHUTE.ToString()),
                        2, 0, 0, 0, 0, 0, 0);
        }
