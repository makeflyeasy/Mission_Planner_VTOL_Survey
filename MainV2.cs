...
namespace MissionPlanner
{
 ...
 /*               if (DisplayConfiguration.displayScriptsTab && !t.TabPages.Contains(FlightData.tabScripts))
        ...
        public MainV2()
        {
            ...
            srtm.datadirectory = /*Settings.GetDataDirectory()*/ "C:\\ProgramData\\Mission Planner Vtol Survey\\"+
                                 "srtm";
            ...
            string temp2 = /*Settings.Instance.BaudRate*/"57600";
            ...
            {
               // 解锁锁定.Click -= this.Menulock_Click;
               // 解锁锁定.Text = "";
                //解锁锁定.Image = Program.Logo;

                //解锁锁定.Click += MenuCustom_Click;
        ...
        public void switchicons(menuicons icons)
        {
            ...
            //拍照.Image = displayicons.sim;
            MenuConfigTune.Image = displayicons.config_tuning;
            //重启任务.Image = displayicons.terminal;
            MenuConnect.Image = displayicons.connect;
            //返航.Image = displayicons.help;
            //解锁锁定.Image = displayicons.donate;
            ...
            //拍照.ForeColor = ThemeManager.TextColor;
            MenuConfigTune.ForeColor = ThemeManager.TextColor;
            //重启任务.ForeColor = ThemeManager.TextColor;
            MenuConnect.ForeColor = ThemeManager.TextColor;
            //返航.ForeColor = ThemeManager.TextColor;
            //解锁锁定.ForeColor = ThemeManager.TextColor;
        }
        ...
        static string adminpassword="makeflyeasy";
        static bool Verifystate = false;
       ...
       /* private void Menurestartmission_Click(object sender, EventArgs e)
        {
        ...
        private void Connect()
        {
            ...
            else
            {
                ...
                doConnect(comPort, _connectionControl.CMB_serialport.Text, _connectionControl.CMB_baudrate.Text); connect = true;
        ...
        {
            if (
                 CustomMessageBox.Show("Are you sure you want to do " +" PREFLIGHT_CALIBRATION" + " ?", "Action",
                     MessageBoxButtons.YesNo) == (int)DialogResult.Yes)
            {
                try
                {
                    ...
                    MainV2.comPort.doCommand((MAVLink.MAV_CMD)Enum.Parse(typeof(MAVLink.MAV_CMD), MAVLink.MAV_CMD.PREFLIGHT_CALIBRATION .ToString()),
        ...
        {
            /*string wp = numericUpDown1.Value.ToString();
          
            string repeat ="1";
            
            GCSViews.FlightPlanner jump = new GCSViews.FlightPlanner();
            jump.selectedrow = jump.Commands.Rows.Add();

            jump.Commands.Rows[jump.selectedrow].Cells[jump.Command.Index].Value = MAVLink.MAV_CMD.DO_JUMP.ToString();

            jump.Commands.Rows[jump.selectedrow].Cells[jump.Param1.Index].Value = wp;

            jump.Commands.Rows[jump.selectedrow].Cells[jump.Param2.Index].Value = repeat;
       ...
       /* private void button4_Click(object sender, EventArgs e)
        ...
        private void button2_Click_2(object sender, EventArgs e)
        {
            ...
            {
                //((Button)sender).Enabled = false;
                MainV2.comPort.setWPCurrent((ushort)numericUpDown1.Value ); // set nav to
            }
            catch
            {
                CustomMessageBox.Show(Strings.CommandFailed, Strings.ERROR);
        ...
        {
            button1.BackgroundImage = global::MissionPlanner.Properties.Resources.飞行计划;
        }

        private void button1_MouseLeave(object sender, EventArgs e)
        {
            button1.BackgroundImage = global::MissionPlanner.Properties.Resources.空速置零;
        }

        private void button2_MouseEnter(object sender, EventArgs e)
        {
            button2.BackgroundImage = global::MissionPlanner.Properties.Resources.跳转航点_亮;
        }

        private void button2_MouseLeave(object sender, EventArgs e)
        {
            button2.BackgroundImage = global::MissionPlanner.Properties.Resources.跳转航点_白;
        }

        private void button2_MouseDown(object sender, MouseEventArgs e)
        {
            button2.BackgroundImage = global::MissionPlanner.Properties.Resources.跳转航点_暗;
        }
        ...
        private void label8_Click(object sender, EventArgs e)
        {
            ...
            //else CustomMessageBox.Show("请连接飞控", "错误");
        }

        private void label8_MouseEnter(object sender, EventArgs e)
        {
            label8.Image = global::MissionPlanner.Properties.Resources.Z跳转航点_亮;
        }

        private void label8_MouseLeave(object sender, EventArgs e)
        {
            label8.Image = global::MissionPlanner.Properties.Resources.Z跳转航点_白;
        }

        private void label8_MouseDown(object sender, MouseEventArgs e)
        {
            label8.Image = global::MissionPlanner.Properties.Resources.Z跳转航点_暗;
        }
        ...
        private void label9_Click(object sender, EventArgs e)
        {
            if (connect == true)
            {
                ...
                {
                    if (MainV2.comPort.MAV.cs.armed)
                        if (CustomMessageBox.Show("确认锁定?", "Disarm?", MessageBoxButtons.YesNo) !=
                            (int)DialogResult.Yes)
                        {
                            return;
                        }
        ...
        {
            if (cot%2==0)
                label9.Image = global::MissionPlanner.Properties.Resources.Z锁定_暗;
            else label9.Image = global::MissionPlanner.Properties.Resources.Z解锁_暗;
        }

        private void label9_MouseEnter(object sender, EventArgs e)
        {
            if (cot % 2 == 0)
                label9.Image = global::MissionPlanner.Properties.Resources.Z锁定_亮;
            else label9.Image = global::MissionPlanner.Properties.Resources.Z解锁_亮;
        }

        private void label9_MouseLeave(object sender, EventArgs e)
        {
            if (cot % 2 == 0)
                label9.Image = global::MissionPlanner.Properties.Resources.Z锁定_白;
            else label9.Image = global::MissionPlanner.Properties.Resources.Z解锁_白;
        }
        ...
        {
            label10.Image = global::MissionPlanner.Properties.Resources.Z自动飞行_暗;
        }

        private void label10_MouseEnter(object sender, EventArgs e)
        {
            label10.Image = global::MissionPlanner.Properties.Resources.Z自动飞行_亮;
        }

        private void label10_MouseLeave(object sender, EventArgs e)
        {
            label10.Image = global::MissionPlanner.Properties.Resources.Z自动飞行_白;
        }
        ...
        {
            label11.Image = global::MissionPlanner.Properties.Resources.Z立即返航_暗;
        }

        private void label11_MouseEnter(object sender, EventArgs e)
        {
            label11.Image = global::MissionPlanner.Properties.Resources.Z立即返航_亮;
        }

        private void label11_MouseLeave(object sender, EventArgs e)
        {
            label11.Image = global::MissionPlanner.Properties.Resources.Z立即返航_白;
        }
        ...
        {
            label12.Image = global::MissionPlanner.Properties.Resources.Z重启任务_暗;
        }

        private void label12_MouseEnter(object sender, EventArgs e)
        {
            label12.Image = global::MissionPlanner.Properties.Resources.Z重启任务_亮;
        }

        private void label12_MouseLeave(object sender, EventArgs e)
        {
            label12.Image = global::MissionPlanner.Properties.Resources.Z重启任务_白;
        }
        ...
        {
            label14.Image = global::MissionPlanner.Properties.Resources.Z空速置零_暗;
        }

        private void label14_MouseEnter(object sender, EventArgs e)
        {
            label14.Image = global::MissionPlanner.Properties.Resources.Z空速置零_亮;
        }

        private void label14_MouseLeave(object sender, EventArgs e)
        {
            label14.Image = global::MissionPlanner.Properties.Resources.Z空速置零_白;
        }
        ...
        {
            label13.Image = global::MissionPlanner.Properties.Resources.Z点击拍照_暗;
        }

        private void label13_MouseEnter(object sender, EventArgs e)
        {
            label13.Image = global::MissionPlanner.Properties.Resources.Z点击拍照_亮;
        }

        private void label13_MouseLeave(object sender, EventArgs e)
        {
            label13.Image = global::MissionPlanner.Properties.Resources.Z点击拍照_白;
        }
        ...
        {
            label15.Image = global::MissionPlanner.Properties.Resources.Z提取POS_暗;
        }

        private void label15_MouseUp(object sender, MouseEventArgs e)
        {
            label15.Image = global::MissionPlanner.Properties.Resources.Z提取POS_白;
        }

        private void label15_MouseEnter(object sender, EventArgs e)
        {
            
                label15.Image = global::MissionPlanner.Properties.Resources.Z提取POS_亮;
        ...
        private void label20_Click(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Process.Start(path + "\\demo5_b31a\\ppk_qt.exe");
        }

        private void label17_MouseDown(object sender, MouseEventArgs e)
        {
            label17.Image = global::MissionPlanner.Properties.Resources.ZRTK配置_暗;
        }
        private void label17_MouseEnter(object sender, EventArgs e)
        {

            label17.Image = global::MissionPlanner.Properties.Resources.ZRTK配置_亮;

        }
        private void label17_MouseLeave(object sender, EventArgs e)
        {

            label17.Image = global::MissionPlanner.Properties.Resources.ZRTK配置_白;
        }
        ...
        {
            label20.Image = global::MissionPlanner.Properties.Resources.ZPPK解算_暗;
        }
        private void label20_MouseEnter(object sender, EventArgs e)
        {

            label20.Image = global::MissionPlanner.Properties.Resources.ZPPK解算_亮;

        }
        private void label20_MouseLeave(object sender, EventArgs e)
        {

            label20.Image = global::MissionPlanner.Properties.Resources.ZPPK解算_白;
        }
        ...
        private void label22_Click(object sender, EventArgs e)
        {
            try
            {
                FtpWeb fw = new FtpWeb("47.108.137.134", "TechnicalSupport", "doc", "bfxKe68Erv4qB");


                string status = fw.Download(Settings.GetRunningDirectory(), "TechnicalSupport.txt");
                StreamReader sr = new StreamReader(Settings.GetRunningDirectory() + "TechnicalSupport.txt");
                string strRead = sr.ReadLine();
                System.Diagnostics.Process.Start(strRead);
            }
            catch
            {
        ...
        {
            label22.Image = global::MissionPlanner.Properties.Resources.Z技术支持_暗;
        }

        private void label22_MouseEnter(object sender, EventArgs e)
        {
            label22.Image = global::MissionPlanner.Properties.Resources.Z技术支持_亮;
        }

        private void label22_MouseLeave(object sender, EventArgs e)
        {
            label22.Image = global::MissionPlanner.Properties.Resources.Z技术支持_白;
        }
        ...
        private void self_inspection_Click(object sender, EventArgs e)
        {
            CheckListControl frm = new CheckListControl();
            frm.ShowUserControl();
        }
    }
    }
