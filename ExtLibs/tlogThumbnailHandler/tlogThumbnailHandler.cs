...
namespace tlogThumbnailHandler
{
    ...
    public class tlogThumbnailHandler : IThumbnailProvider, IInitializeWithStream, IExtractImage2, IExtractImage, IPersistFile, IDisposable
    {
        ...
        public static string queuefile = commonAppData + Path.DirectorySeparatorChar + "Mission Planner Vtol Survey" + Path.DirectorySeparatorChar + "tlogimagecache" + Path.DirectorySeparatorChar + "queue.txt";
