...
namespace MissionPlanner
{
    public class CurrentState : ICloneable
    {
        ...
        [DisplayText("WP No")]
        public float wpno { get => _wpno; set => _wpno = value; }
        ...
        public static double DistToHome1 = 0;
        public static double distTraveled1 = 0;
        ...
        public float distTraveled { get => s_distTraveled; set => s_distTraveled = value; }
        ...
        public float DistToHome
        {
            get
            {
                ...
                DistToHome1 = Convert.ToInt32(Math.Sqrt((dstlat * dstlat) + (dstlon * dstlon)) * multiplierdist);
        ...
        public static float s_distTraveled;
        private float _wpno;
                    ...
                    if (datetime.Second != lastsecondcounter.Second)
                    {
                        ...
                        if (lastpos.Lat != 0 && lastpos.Lng != 0 && armed)
                        {
                            ...
                            distTraveled += (float)lastpos.GetDistance(new PointLatLngAlt(lat, lng, 0, "")) *
                                            multiplierdist;
                            //distTraveled1 = Convert.ToInt32(distTraveled);
