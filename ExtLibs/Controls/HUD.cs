...
namespace MissionPlanner.Controls
{
    public class HUD : GLControl
    {
        ...
        private float _batterylevel2 = 0;
        private float _current2 = 0;
        private float _batteryremaining2 = 0;
            ...
            set
            {

                {
                    if (value == "Auto")
                        ...
                        _mode = "固定翼增稳";
                    else if (value == "QSTABILIZE")
                        _mode = "多轴增稳";
                    else if (value == "QLOITER")
                        _mode = "多轴定点";
                    else if (value == "QRTL")
                        _mode = "多轴返航";
                    else if (value == "RTL")
        ...
        void doPaint()
        {
            ...
            try
            {
                ...
                if (displayalt)
                {
                    ...
                    drawstring(_mode, font, fontsize, _whiteBrush, scrollbg.Left - 50,
                        scrollbg.Bottom + 5);
                ...
                if (displaygps)
                {
                    ...
                    foreach (var _fix in new[] { _gpsfix, _gpsfix2 })
                    {
                        ...
                        if (a == 0) gps = gps.Replace("GPS:", "GPS1:");
                        // gps2re
                ...
                {
                    if (message == "NO RC Receiver")

                        drawstring("没有遥控信号", font, fontsize + 10, (SolidBrush)Brushes.Red, -halfwidth + 50,
                            halfheight / 3);
                    else if (message == "Bad or No Terrain Data")
                        drawstring("地形高差异常", font, fontsize + 10, (SolidBrush)Brushes.Red, -halfwidth + 50,
                            halfheight / 3);
                    else if (message == "Bad AHRS")
                        drawstring("", font, fontsize + 10, (SolidBrush)Brushes.Red, -halfwidth + 50,
                            halfheight / 3);
                    else if (message == "Bad GPS Signal Health")
                        drawstring("", font, fontsize + 10, (SolidBrush)Brushes.Red, -halfwidth + 50,
                            halfheight / 3);
                    else drawstring(message, font, fontsize + 10, (SolidBrush)Brushes.Red, -halfwidth + 50,
                        halfheight / 3);
                }
