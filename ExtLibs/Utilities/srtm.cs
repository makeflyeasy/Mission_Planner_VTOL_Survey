  ...
  jump:          try
            {
                ...
                {
                    FtpWeb fw = new FtpWeb("47.108.137.134", "Elevationdata", "doc", "bfxKe68Erv4qB");
                    if (fw.FileExist(filename))
                        fw.Download(datadirectory + Path.DirectorySeparatorChar, filename);
                }*/
